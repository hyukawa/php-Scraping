...
print<<<eof
  ...
  <table>
   ...
   <tr height=50px><td width="10%"><img src=/seibusinjukusen20180403.png width="100%"></td><td width="50%"><img src=/seibusinjukusen-228px-43px-000000-F105.png width="50%"></td><td class="entry-content" width="40%">$led_pat[3]</td></tr>
  </table> 
eof;
  //<table>
