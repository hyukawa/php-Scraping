...
print<<<eof
  ...
  <table>
   <tr height=100px><td bgcolor="#80c241" width="10%"></td><td wi5th="40%"><img src=/yamanote-226px-73px-000000-F105.png width="30%"></td><td class="entry-content" width="45%">$led_pat[0]</td></tr>
